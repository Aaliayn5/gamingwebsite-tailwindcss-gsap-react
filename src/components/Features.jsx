...
const BentoTilt = ({children, className = ''}) => {
  ...
  const handleMouseMove = (e) => {
    ...
    const rotateX = (relativeY - 0.5) * 86.4
    const rotateY = (relativeX - 0.5) * 86.4
    ...
    <section className='bg-black pb-52'>
      <div className='container mx-auto px-3 md:px-10'>
        <div className='px-5 py-32'>
          ...
          <p className='text-blue-50 text-lg font-circular-web max-w-md'>
            Immerse yourself in a rich and ever-expanding universe,
            where a vibrant array of products converge into an interconnected overlay
